  ...
  requireAuthentication(transition, routeOrCallback) {
    ...
    if (!isAuthenticated) {
      ...
      if (argType === 'string') {
        ...
        assert(`The second argument to requireAuthentication must be a String of Function, got "${argType}"!`, false);
      }
    }
  ...
  prohibitAuthentication(routeOrCallback) {
    ...
    if (isAuthenticated) {
      ...
      if (argType === 'string') {
        ...
        assert(`The second argument to prohibitAuthentication must be a String of Function, got "${argType}"!`, false);
      }
    }
    return !isAuthenticated;
  },
